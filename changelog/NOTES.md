...
The four themes use native `WM_CTLCOLOREDIT`, `WM_CTLCOLORSTATIC`, and background painting. The Windows menu bar and common dialogs continue to follow the operating system appearance.
